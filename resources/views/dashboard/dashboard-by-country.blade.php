<x-layout>
  ...
  <input type="text" name="search" value="{{ $search }}" placeholder="{{__('statistics.search')}}" class="pl-12 pr-4 py-2 rounded-lg  focus:outline-none focus:ring  focus:border-blue-300">
