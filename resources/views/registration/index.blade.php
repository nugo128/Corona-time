      ...
      <div class="bg-white rounded-md w-full sm:max-w-md px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12">
          ...
          <form action="POST" class="mt-4">
            ...
            <label for="password-r" class="font-bold block mt-4">Repeat Password</label>
            <input type="password" name="password-r" placeholder="Repeat Password" class="w-full px-6 py-4 mt-3 rounded-md border-gray-300 border-solid border focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
